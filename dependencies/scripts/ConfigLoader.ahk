...
global NoteCreateKey := IniRead(configFile, "Hotkeys", "HotkeyNoteCreate", "")
...
global MessageCentreReplyGUIKey := IniRead(configFile, "Hotkeys", "HotkeyMessageCentreReplies", "")
global TriageKey := IniRead(configFile, "Hotkeys", "HotkeyTriage", "")
